...
describe('Partner Drop Sales Funtionality', function (){
    const partnerdrop= new ProductDrop
    beforeEach (function (){
    ...
    beforeEach (function(){
        ...
        partnerdrop.getclickPartnerDrop().click({force:true})
    });
        it('Hide the drop which is published earlier ',function(){
            partnerdrop.getDrop().each(($el,index,$list)=>{
