...
describe('GET THE STARDUST-HERO METADATA WITH API TEST',()=>{
    it('Getting the MetaData of the Stardust-Hero  and Varifying the response code & MetaData', () => {

        cy.fixture('api/StardustMetadata/stardustHeroMetaData').then(myFixture => {  
        ...
        cy.request({
            ...
            url:"https://api.staging-guildofguardians.com/api/player-wallet/nfts/"+walletAddress+"/"+nftToken
                ...
                expect(assetcatagory).to.be.equal('"Hero"')
            });
        });
    });
});
