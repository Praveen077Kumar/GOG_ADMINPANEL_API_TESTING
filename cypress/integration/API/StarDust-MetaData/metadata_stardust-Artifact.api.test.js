...
describe('GET THE STARDUST-ARTIFACT METADATA WITH API TEST',()=>{
    it('Getting the MetaData of the Stardust-Artifact and Varifying the response code & MetaData', () => {

        cy.fixture('api/StardustMetadata/stardustArtifactMetaData').then(myFixture => {  
