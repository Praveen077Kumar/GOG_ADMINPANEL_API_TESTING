...
describe('GET THE STARDUST-GUILD-TOKEN METADATA WITH API TEST',()=>{
    it('Getting the MetaData of the Stardust-Guild-Token and Varifying the response code & MetaData', () => {

        cy.fixture('api/StardustMetadata/stardustGuildMetaData').then(myFixture => {  
